...
class AdminMaterialController extends Controller
{
	...
	public function indexAction(Request $request)
	{
    	...
    	return $this->render(
    		'SmpAppBundle:Admin:admin_materials.html.twig', array(
	...
	public function searchAction(Request $request)
	{
    	...
    	return $this->render('SmpAppBundle:Admin:admin_material_search.html.twig', array(
	...
	public function newAction(Request $request)
	{
		...
		return $this->render('SmpAppBundle:Admin:admin_material_new.html.twig', array(
	...
	public function editAction(Request $request, $id)
	{
		$material = $this->getDoctrine()
	        ->getRepository('SmpAppBundle:Material')
	        ->find($id);
		...
		return $this->render('SmpAppBundle:Admin:admin_material_edit.html.twig', array(
			'material'				=>	$material,
			'admin_material_form'	=>	$form->createView()
		));
	}
